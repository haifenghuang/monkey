...
* [Table of Contents](#table-of-contents)
  ...
  * [Markdown document generator](#markdown-document-generator)
...
Included also has a tool(`mdoc`) for generating documentation in markdown format.

It only support below statement for document generator:
...
Look at [markdown.md](examples/markdown.md) to see how documentation generated by mdoc looks like.
